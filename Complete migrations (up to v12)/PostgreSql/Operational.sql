...
START TRANSACTION;
ALTER TABLE "PushedAuthorizationRequests" ALTER COLUMN "ReferenceValueHash" TYPE character varying(64);
UPDATE "PushedAuthorizationRequests" SET "ReferenceValueHash" = '' WHERE "ReferenceValueHash" IS NULL;
ALTER TABLE "PushedAuthorizationRequests" ALTER COLUMN "ReferenceValueHash" SET NOT NULL;
ALTER TABLE "PushedAuthorizationRequests" ALTER COLUMN "ReferenceValueHash" SET DEFAULT '';

UPDATE "PushedAuthorizationRequests" SET "Parameters" = '' WHERE "Parameters" IS NULL;
ALTER TABLE "PushedAuthorizationRequests" ALTER COLUMN "Parameters" SET NOT NULL;
ALTER TABLE "PushedAuthorizationRequests" ALTER COLUMN "Parameters" SET DEFAULT '';
